...
public class ParallaxController : MonoBehaviour
{
    ...
    void Start()
    {
       ...
       // float zOffset = 0.1f; // Adjust this value to set the z-offset between backgrounds
        ...
        for (int i = 0; i < backCount; i++)
        {
            ...
            // Set the z-position of the background objects with an offset between them
            Vector3 position = backgrounds[i].transform.position;
           // position.z = i * zOffset;
    ...
    private void LateUpdate()
    {
        ...
        for (int i = 0; i < backgrounds.Length; i++)
        {
            ...
            float speedY = 0;// speedX / 2;  // if you close Y movement , set to 0
